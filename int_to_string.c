...
char *char_get(int num);
unsigned int _abs(int);
int _len_buffer(unsigned int num, unsigned int base);
void buff_fill(unsigned int num, unsigned int base,
		       char *buff, int buff_size);

/**
 * char_get - gets a character pointer to new string containing int
...
/**
 * _len_buffer - gets length of buffer needed for an unsigned int
